...
const Days = [
  {
    ...
    classes: [
      ...
      {
        class: "6",
        subjects: ["Algebra", "Literature", "Chemistry", "World History"],
      },
  ...
  },
  {
    ...
    classes: [
      {
        class: "5",
        subjects: ["Chemistry", "Biology", "Art", "Physical Education"],
      },
      {
        class: "6",
        subjects: ["Geometry", "English Literature", "Physics", "Geography"],
      },
      {
        class: "7",
        subjects: ["Chemistry", "Biology", "Art", "Physical Education"],
  ...
  },
  {
    ...
    classes: [
      ...
      {
        class: "6",
        subjects: ["Physical Education", "Chemistry", "Literature", "Art"],
      },
  ...
  },
  {
    ...
    classes: [
      {
        class: "5",
        subjects: ["Physical Education", "Art", "Chemistry", "Biology"],
      },
      {
        class: "6",
        subjects: ["English", "Geometry", "Music", "World History"],
      },
      {
        class: "7",
        subjects: ["Physical Education", "Art", "Chemistry", "Biology"],
  ...
  },
  {
    ...
    classes: [
      {
        class: "5",
        subjects: ["Biology", "History", "Geography", "Computer Science"],
      },
      {
        class: "6",
        subjects: ["Computer Science", "Geography", "Algebra", "Physics"],
      },
      {
        class: "7",
        subjects: ["Biology", "History", "Geography", "Computer Science"],
